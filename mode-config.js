...
// │     • URL de redirection OAuth : [votre GitHub Pages]/editeur/     │
// │       oauth-callback.html                                          │
// │       ex : https://nouilleske.github.io/overlay/editeur/           │
// │                oauth-callback.html                                  │
// │                                                                     │
// │  2. Copiez le Client ID affiché et collez-le ci-dessous.          │
// │  3. Collez l'URL de redirection que vous avez enregistrée.        │
// │                                                                     │
...
const TWITCH_REDIRECT   = "";   // ex: "https://nouilleske.github.io/overlay/editeur/oauth-callback.html"
        ...
        <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:16px;">
          ...
          <div style="background:${goldBg};border:1px solid ${goldBd};border-radius:5px;padding:14px;">
            ...
            <div id="cfgRedirectDisplay"
              ...
              ${esc(guessedRedirect) || "https://VOTRE_PSEUDO.github.io/VOTRE_REPO/editeur/oauth-callback.html"}
            </div>
            ${guessedRedirect ? `
          ...
          <div style="background:${goldBg};border:1px solid ${goldBd};border-radius:5px;padding:14px;">
            <div style="font-size:11px;color:${gold};font-weight:bold;margin-bottom:6px;">
              ③ Collez votre Client ID dans le fichier editeur/mode-config.js
            </div>
            <div style="font-size:10px;opacity:0.6;margin-bottom:8px;line-height:1.6;">
              Après avoir créé l'application, copiez le <strong>Client ID</strong> affiché
              et renseignez-le à la ligne&nbsp;20 du fichier <code>editeur/mode-config.js</code> :
            </div>
            <div style="background:#0a1322;border:1px solid ${goldBd};border-radius:3px;
              ...
              const TWITCH_REDIRECT&nbsp;&nbsp;&nbsp; = <span style="color:#8fd080;">"https://…/editeur/oauth-callback.html"</span>;
            </div>
          </div>
